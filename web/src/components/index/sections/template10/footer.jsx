                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="text-center md:text-left">
                            ...
                            <ul className="space-y-2">
                                {sectionData.navData.map((item) => (
                                    <li key={item.name}>
                                        <Link href={item.href}
                                              className="text-white\/50 hover:text-mainColorNormal transition-colors flex items-center justify-center md:justify-start">
                        ...
                        <div className="text-center md:text-left">
                            ...
                            <ul className="space-y-3">
                                <li className="flex items-start justify-center md:justify-start">
                                    ...
                                    <span className="text-white\/50 hover:text-mainColorNormal transition-colors flex items-center justify-center md:justify-start">{sectionData.contactData.global_email}</span>
                                </li>
                                <li className="flex items-start justify-center md:justify-start">
                                    <div className="text-mainColorNormal mr-2 mt-1">
                                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                    ...
                                    <span className="text-white\/50 hover:text-mainColorNormal transition-colors flex items-center justify-center md:justify-start">{sectionData.contactData.global_phone}</span>
                                </li>
                                <li className="flex items-start justify-center md:justify-start">
                                    <div className="text-mainColorNormal mr-2 mt-1">
                                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                    ...
                                    <span className="text-white\/50 hover:text-mainColorNormal transition-colors flex items-center justify-center md:justify-start">{sectionData.contactData.global_address}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div className="flex flex-col text-sm text-gray-500 mb-4 sm:mb-0">
                            <p className="hover:text-mainColorNormal transition-colors flex items-center justify-center md:justify-start">Copyright &copy; {new Date().getFullYear()} {sectionData.contactData.global_company_name}
                            </p>
                            <p className="mt-1 hover:text-mainColorNormal transition-colors flex items-center justify-center md:justify-start">Powered by <a href="https://fktool.com" target="_blank"
                        ...
                        <div className="flex flex-wrap justify-center space-x-4">
                            {sectionData.contactData.global_facebook?.length > 0 && (
                                <Link href={sectionData.contactData.global_facebook}
                                      target="_blank"
                                      className="text-white\/50 hover:text-mainColorNormal transition-colors">
