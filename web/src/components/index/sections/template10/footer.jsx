                        ...
                        <div className="text-center md:text-left">
                            ...
                            <ul className="space-y-3">
                                <li className="flex items-start justify-center md:justify-start">
                                    ...
                                    <span className="text-white\/50">{sectionData.contactData.global_email}</span>
                                </li>
                                <li className="flex items-start justify-center md:justify-start">
                                    <div className="text-mainColorNormal mr-2 mt-1">
                                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                    ...
                                    <span className="text-white\/50">{sectionData.contactData.global_phone}</span>
                                </li>
                                <li className="flex items-start justify-center md:justify-start">
                                    <div className="text-mainColorNormal mr-2 mt-1">
                                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                    ...
                                    <span className="text-white\/50">{sectionData.contactData.global_address}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
